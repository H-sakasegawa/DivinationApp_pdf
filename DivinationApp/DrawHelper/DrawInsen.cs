...
namespace DivinationApp
{
    ...
    class DrawInsen : IsouhouBase
    {
        ...
        private void CalcCoord()
        {
            if (bDispTenchusatu)
            {
                nikkansi.X = (int)drawAreaOffset.X + 60;
            }
            else
            {
                nikkansi.X = (int)drawAreaOffset.X + 10;
            }
            //nikkansi.Y = GetDrawArea().Height / 2 - rangeHeight;
            nikkansi.Y = (int)drawAreaOffset.Y + 10;
        ...
        private void DrawZouganItem(GraphicsBase g, string genso, Rectangle rect, Color color, bool bBold, bool bShugosin=true)
        {
            var fntZougan = fnt;
            if (bBold)
            {
        ...
        private void DrawTenchusatuItem(GraphicsBase g, string genso, Rectangle rect, Color color, bool bBold)
        {
            var fntZougan = fnt;
            if (bBold)
            {
        ...
        public void DrawArrowLine(GraphicsBase g, Rectangle rectStart, Rectangle rectEnd)
        {
        ...
        private void DrawArrowLine(GraphicsBase g, Point start, Point end)
        {
