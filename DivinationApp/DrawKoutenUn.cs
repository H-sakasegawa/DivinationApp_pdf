...
namespace DivinationApp
{
    ...
    class DrawKoutenUn : IsouhouBase
    {
        ...
        /// </summary>
        /// <param name="g"></param>
        protected override void DrawKansi(GraphicsBase g, JuniSinkankanHouAttr attrJuniSinkanHou = null)
        {
        ...
        /// </summary>
        /// <param name="g"></param>
        private void DrawZougan(GraphicsBase g, JuniSinkankanHouAttr attrJuniSinkanHou=null)
        {
            if (bDispZougan)
            {
